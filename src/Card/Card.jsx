  ...
  return (
    <div className="card">
      <div className="card__rating">
        <svg className="card__star" width="16px" height="16px" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <img className="card__img" src={`/films/${img}`} alt="" />
      <p className="card__title">{title}</p>
      <div className="favorite">
        <svg className="card__like" width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
